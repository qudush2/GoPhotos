      ...
      <div className="mt-2">
        <div>
          ...
          >
            ...
            >
              <div className="sm:w-full">
                <div className="flex w-full items-center">
                  ...
                  <div>
                    <p className="text-base sm:text-lg font-medium">{account.fullName}</p>
                    <p className="text-xs sm:text-base text-gray-600 ">Cambridge, MA</p>
                  </div>
                </div>
                <div className="mt-5">
                  <p className="mb-0.5 text-sm sm:text-base font-medium">About</p>
                  <p className="text-sm sm:text-base">{photographer.about}</p>
                </div>
                <div className="mt-5">
                  <p className="mb-0.5 text-sm sm:text-base font-medium">School</p>
                  <p className="text-sm sm:text-base">{photographer.school}</p>
                </div>
                <div className="mt-5">
                  <p className="mb-0.5 text-sm sm:text-base font-medium">Experience</p>
                ...
                <div className="mt-5">
                  <p className="mb-1 text-sm sm:text-base font-medium">Skills</p>
            ...
            >
              <p className="text-base sm:text-lg font-medium">Estimated price</p>
