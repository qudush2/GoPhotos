    ...
    <div className="px-8 md:px-20 md:py-7">
      ...
      <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {jobDetails.map((job, index) => (
          <li key={jobIDs[index]} className="bg-white rounded-lg shadow-md overflow-hidden">
            <Link href={`/gallery/${job.conversation_id}`} className="block hover:opacity-75 transition-opacity">
              ...
              <div className="p-4">
                <h2 className="text-lg font-semibold text-gray-800">{job.event_title}</h2>
              </div>
            </Link>
          </li>
        ))}
