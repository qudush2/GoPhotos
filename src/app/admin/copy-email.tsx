...
export const CopyEmailsButton: React.FC<CopyEmailsButtonProps> = ({ emails }) => {
  ...
  return (
    <div>
      <button onClick={copyEmailsToClipboard} className="ml-2 bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-2 rounded">
        Copy
      </button>
