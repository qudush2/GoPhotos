...
import { UnauthorizedError, PhotographerDoesNotExist } from '@/src/utils/errors'
...
export default function Error({
  ...
  reset: () => void;
    ...
    if (error instanceof PhotographerDoesNotExist) {
        return (
            <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
                <h1 className="text-4xl font-bold text-red-600 mb-4">404 - Not Found</h1>
                <p className="text-xl text-gray-700 mb-8">Sorry, this photographer page does not exist. Make sure you have the correct URL.</p>
                <button
                    onClick={() => reset()}
                    className="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 transition-colors"
                >
